        ...
        appBar: AppBar(
          title: Row(
            ...
            children: [
              ...
              CircleAvatar(radius: 20, backgroundColor: Colors.red, child: IconButton(onPressed: null, icon: Icon(Icons.person_2_outlined)))
            ],
          ),
          ...
          child: Column(
            ...
            children: [
              ChooseCard(
                ...
                activitieImage: "https://media-cdn.tripadvisor.com/media/photo-s/15/6d/92/a6/inside.jpg",
                onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => ActivityPlacePage(
                      title: "où allé ?",
                    ),
                  ),
                ),
              ...
              ChooseCard(
                ...
                activitieImage: "https://img.freepik.com/photos-gratuite/belle-photo-du-sentier-du-parc-entoure-nature-incroyable_181624-30887.jpg?size=626&ext=jpg",
              ),
              Padding(
